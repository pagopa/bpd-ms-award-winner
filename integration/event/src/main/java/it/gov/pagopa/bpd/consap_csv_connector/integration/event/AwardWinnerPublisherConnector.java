...
@Service
public class AwardWinnerPublisherConnector extends BaseEventConnector<PaymentInfo, Boolean, PaymentInfo, Void> {

    /**
     * @param paymentInfo         PaymentInfo instance to be used as message content
