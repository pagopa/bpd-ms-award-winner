...
import it.gov.pagopa.bpd.award_winner.connector.award_period.config.AwardPeriodRestConnectorConfig;
...
@TestPropertySource(
        ...
        properties = "spring.application.name=bpd-ms-award-winner-integration-rest")
...
public class AwardPeriodRestClientTest extends BaseFeignRestClientTest {
    ...
    private Optional<List<AwardPeriod>> getCachedAwardPeriods() {
        return Optional.ofNullable(cacheManager.getCache("awardPeriods")).map(c -> c.get("getAwardPeriods", List.class));
    }
    ...
    public void getAwardPeriods_cacheHit() {
        ...
        final List<AwardPeriod> actualResponse1 = restClient.getAwardPeriods();
        ...
        final List<AwardPeriod> actualResponse2 = restClient.getAwardPeriods();
