...
//@Service
//@Slf4j
//public class OnIntegratedPaymentRequestListener extends BaseConsumerAwareEventListener {
//
...
//
//    @Autowired
//    public OnIntegratedPaymentRequestListener(
...
//
//
//            if (headers.lastHeader(ListenerHeaders.INTEGRATION_PAYMENT_HEADER) == null ||
